...
#include "stdafx.h"
#include "spitonicstereodelaysynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicstereodelaysynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicstereodelaysynthvoroguiwin32class"};				// the main window class name
